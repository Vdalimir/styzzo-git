...
addComment = (function (window, undefined) {
    ...
    // settings
    var config = {
        commentReplyClass: "comment__reply",
        cancelReplyId: "cancel-comment-reply",
    ...
    function cancelEvent(event) {
        ...
        respondElement.classList.remove("moved");
    ...
    function clickEvent(event) {
        ...
        follow = addComment.moveForm(replyLink);
        if (false === follow) {
            event.preventDefault();
        }
    }
    ...
    function moveForm(button) {
        // get elements based on their IDs
        var addBelowElement = button.closest(".comment__body");
        respondElement = getElementById("respond");

        var postId = getDataAttribute(button, "postid");
        ...
        respondElement.classList.add("moved");
        ...
        parentIdField.value = getDataAttribute(button, "commentid");
